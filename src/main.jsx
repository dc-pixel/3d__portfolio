...
function Scene3D() {
  return <div className="hero-3d" aria-label="Decorative 3D developer graphic">
    <div className="scene">
...
function About() {
  return <section id="about" className="section-shell split-section">
    <div className="section-label">01 / ABOUT</div>
    <div className="section-content"><h2>Backend thinking.<br /><span>Full-stack execution.</span></h2><p>Software Engineer skilled in backend development, RESTful APIs, SQL, MySQL, Java, C++, and data structures and algorithms.</p><p>I build maintainable and efficient solutions around clear APIs, relational data models, indexing, JOIN-based query optimization, OOP and modular design, with a focus on scalable application development.</p><div className="stat-row"><div><strong>2026</strong><span>Computer Science graduate</span></div><div><strong>7.52</strong><span>CGPA / 10</span></div><div><strong>01</strong><span>Industry internship</span></div></div></div>
  </section>;
}
