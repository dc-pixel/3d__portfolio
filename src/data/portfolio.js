...
export const skills = [
  ['Languages',['C++','Java','JavaScript','SQL']],['Frontend',['React.js','Next.js','HTML','CSS']],['Backend',['Node.js','Express.js','RESTful APIs','JSON','JWT','Authentication']],['Databases',['MySQL','DBMS','Normalization','Indexing','JOINs','Query Optimization','SQL Aggregation']],['DSA',['Data Structures','Algorithms','Trie','Sorting','Searching','Complexity Analysis']],['AI / GenAI',['LLM Integration','RAG','Embeddings','AI Resume Analysis','AI Interview Evaluation']],['Programming',['OOP','Pointers','Memory Management','Exception Handling','Modular Design']],['Tools / DevOps',['Git','GitHub','VS Code','CI/CD']]
];
